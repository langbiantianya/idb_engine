...
**系统拓扑流（gRPC 模式）：**
`[前端 Webview]` ↔ `[Wails Go 主进程]` ↔ `(gRPC HTTP/2 + Protobuf)` ↔ `[Kotlin 引擎进程]` ↔ `[MySQL / PostgreSQL / H2 / DuckDB / SQLite]`
